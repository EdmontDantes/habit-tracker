...
<div class="choose-days-completed" id="days-completed-id-${numId}">
    ...
    <img src="./assets/days_of_week/Daily_unchecked.png" id="additional-week-${numId}" alt="add-week-bubble">
</div>`
    ...
    const addExtra = document.querySelector(`#additional-week-${numId}`) {
